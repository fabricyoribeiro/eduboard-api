...
class IndividualAnalyticsDao:
    ...
    def get_individual_analysis(self):
        ...
        desempenho = self.get_individual_performance_predict()
    ...
    def get_individual_performance_predict(self):
        ...
        individual_variables = self.get_individual_variables()

        print(knn.get_params())
        #{'algorithm': 'auto', 'leaf_size': 30, 'metric': 'minkowski', 'metric_params': None, 'n_jobs': None, 'n_neighbors': 5, 'p': 2, 'weights': 'uniform'}

        # Lista de saída
        # individual_variables agora é um único dicionário (não uma lista)
        features = [[
            individual_variables["accuracy"],
            individual_variables["game_time"],
            individual_variables["average_time_per_attempt"],
            individual_variables["attempts"]
        ]]
        ...
        # Resultado único
        result = {
            "actor": individual_variables["actor"],
            "accuracy": individual_variables["accuracy"],
            "game_time": individual_variables["game_time"],
            "average_time_per_attempt": individual_variables["average_time_per_attempt"],
            "attempts": individual_variables["attempts"],
